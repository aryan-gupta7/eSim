...
function installDependency
{
    ...
    # Manually install libgit2-1.8 (required by KiCad PPA but missing from plucky repos)
    echo "Installing libgit2-1.8..............."
    wget -q https://launchpad.net/ubuntu/+archive/primary/+files/libgit2-1.8_1.8.4+ds-3ubuntu2_amd64.deb -O /tmp/libgit2-1.8.deb
    sudo dpkg -i /tmp/libgit2-1.8.deb
    rm /tmp/libgit2-1.8.deb
}
